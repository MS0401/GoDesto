...
- (NSValue *)attributedTextRangeForPoint:(CGPoint)point {
	...
	CGPoint textContainerOffset = CGPointMake(0.0f,0.0f);
    textContainerOffset =  CGPointMake((CGRectGetWidth(self.bounds) - CGRectGetWidth(textBoundingBox)) * 0.5 - CGRectGetMinX(textBoundingBox), 0.0f);

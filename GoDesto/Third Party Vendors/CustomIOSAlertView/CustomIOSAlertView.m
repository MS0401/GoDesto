...
- (void)show
{
    ...
    self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];//[UIColor colorWithRed:1 green:1 blue:1 alpha:0.9];
        ...
        // On iOS8, just place the dialog in the middle
            ...
            CGSize keyboardSize = CGSizeMake(0, 0);
                ...
                [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionCurveEaseInOut
                                 animations:^{
                                     self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.4f];//[UIColor colorWithRed:1 green:1 blue:1 alpha:0.9];
...
- (void)close
{
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
					 animations:^{
						 self.backgroundColor = [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:0.0f];//[UIColor colorWithRed:1 green:1 blue:1 alpha:0.9];
